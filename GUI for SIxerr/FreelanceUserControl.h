...
namespace GUIforSIxerr {
	...
	public:
		...
		void SetData(/*String^ fieldName,*/ String^ fieldValue)
		{
			// Assuming you have labels in the tableLayoutPanel1
			//Label^ labelFieldName = gcnew Label();
			Label^ labelFieldValue = gcnew Label();

			//labelFieldName->Text = fieldName;
			labelFieldValue->Text = fieldValue;

			// Add labels to the tableLayoutPanel1
			//tableLayoutPanel1->Controls->Add(labelFieldName);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tableLayoutPanel1->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute,
				653)));
			this->tableLayoutPanel1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.0F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->tableLayoutPanel1->GrowStyle = System::Windows::Forms::TableLayoutPanelGrowStyle::FixedSize;
			this->tableLayoutPanel1->Location = System::Drawing::Point(3, 3);
			this->tableLayoutPanel1->Name = L"tableLayoutPanel1";
			this->tableLayoutPanel1->RowCount = 1;
			this->tableLayoutPanel1->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::AutoSize, 100)));
